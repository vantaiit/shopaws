<div id="featured">
    <div id="mi-slider" class="mi-slider">
        <?php foreach ($dataProvider as $k=> $item) {  if($k>4) break;?>
        <ul>
            <li><a href="#"><img src="http://ecx.images-amazon.com/images/I/41be9tKHu0L._SL160_.jpg" alt="img01"><h4>Boots<br><small>$49.00</small></h4></a><span class="sale">Sale</span></li>
            <li><a href="#"><img src="<?php echo Yii::app()->request->baseUrl;?>/themes/shopymart/images/products/product-22.jpg" alt="img02"><h4>Oxfords<br><small>$49.00</small></h4></a></h4></a></li>
            <li><a href="#"><img src="<?php echo Yii::app()->request->baseUrl;?>/themes/shopymart/images/products/product-21.jpg" alt="img03"><h4>Loafers<br><small>$49.00</small></h4></a></h4></a></li>
            <li><a href="#"><img src="<?php echo Yii::app()->request->baseUrl;?>/themes/shopymart/images/products/product-20.jpg" alt="img04"><h4>Sneakers<br><small>$49.00</small></h4></a></h4></a></li>
        </ul>
        <?php } ?>
